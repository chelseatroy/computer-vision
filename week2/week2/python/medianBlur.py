...
filename = "../../data/images/lena_salt_pepper_noise.jpg"
if args['filename']:
...
cv2.namedWindow("Original Image   --   Median Blurred output", cv2.WINDOW_AUTOSIZE)
cv2.imshow("Original Image   --   Median Blurred output",combined)
