...
cv2.namedWindow("Original Image   --   Bilateral Filter output", cv2.WINDOW_AUTOSIZE)
cv2.imshow("Original Image   --   Bilateral Filter output", combined)	#show filtered image
